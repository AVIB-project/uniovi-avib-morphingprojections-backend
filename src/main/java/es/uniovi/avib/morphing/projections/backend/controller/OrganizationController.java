...
public class OrganizationController {
	...
	public String save(@RequestBody Object organization) {		
		Object result = organizationService.save(organization);

		//log.debug("save: create/update annotation with annotationId: {} from Manager Service", organization.getOrganizationId());
